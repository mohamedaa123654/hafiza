...
class ColorManager {
  static const Color primary = const Color(0xff37a97b);
  static Color darkPrimary = const Color(0xff448170);
  ...
  static Color containerLightGreen = const Color(0xffd9eae3);
